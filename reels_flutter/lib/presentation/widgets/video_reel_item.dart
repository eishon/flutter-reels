...
import 'package:reels_flutter/presentation/widgets/video_description.dart';
import 'package:reels_flutter/presentation/widgets/video_player_widget.dart';
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Icon(Icons.shopping_bag, color: Colors.grey.shade900, size: 22),
